...
struct HotelDataModel {
    ...
    mutating func fillSections(hotel:Hotel) {
        ...
        let hotelDescription = SectionsInfoHotel.description(HotelDescription(grade: hotel.rating, raitingName: hotel.rating_name, nameHotel: hotel.name, adressHotel: hotel.adress, price: ("\(hotel.minimal_price)")))
